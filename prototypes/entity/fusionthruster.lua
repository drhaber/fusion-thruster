  ...
  {
    {
      ...
      pipe_connections =
      {
        {flow_direction = "input-output", connection_type = "normal", connection_category = {"fusion-reactor", "fusion-generator"}, direction = defines.direction.west, position = {-1, 0}},
        {flow_direction = "input-output", connection_type = "normal", connection_category = {"fusion-reactor", "fusion-generator"}, direction = defines.direction.east, position = { 1, 0}}
      }
    },
